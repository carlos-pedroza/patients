 ...
 */
public class SyncDwPatientLog implements Callback<ResultServicePatient> {
    private DataAccessLogic dal;
    private Activity context;
    private Person person;

    public SyncDwPatientLog(Activity context) {
    ...
    public void init(Person person) {
        ...
        if(!key.isEmpty()) {
            ...
            SyncUpAPIAdapter.getApiService().patientDwLogService(key, device, lastSyncServer, this);
        }
    }
