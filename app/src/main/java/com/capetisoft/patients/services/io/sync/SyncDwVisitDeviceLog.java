 ...
 */
public class SyncDwVisitDeviceLog implements Callback<ResultServiceVisit> {
    private DataAccessLogic dal;
    private Activity context;
    private Person person;

    public SyncDwVisitDeviceLog(Activity context) {
    ...
    public void init(Person person) {
        ...
        if(!key.isEmpty()) {
            ...
            SyncUpAPIAdapter.getApiService().visitDeviceDwLogService(key, device, lastSyncServer, this);
        }
    }
    ...
    public void success(ResultServiceVisit resultService, Response response) {
        ...
        SyncDwVisitLog syncDwVisitLog = new SyncDwVisitLog(this.getContext());
        syncDwVisitLog.init(this.person);
    }
